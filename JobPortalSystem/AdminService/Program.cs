...
builder.Host.UseSerilog((ctx, cfg) =>
{
    cfg.ReadFrom.Configuration(ctx.Configuration)
       ...
       .WriteTo.File(new Serilog.Formatting.Compact.CompactJsonFormatter(),
           path: "logs/admin-.log", rollingInterval: RollingInterval.Day);
});
...
// Named HttpClient for calling JobCatalogService to sync Elasticsearch after approve/flag
builder.Services.AddHttpClient("JobCatalogService", client =>
{
    client.BaseAddress = new Uri(
        builder.Configuration["JobCatalogService:BaseUrl"] ?? "http://localhost:5002");
...
app.UseMiddleware<AdminService.Middleware.CorrelationIdMiddleware>();
app.UseSwagger();
